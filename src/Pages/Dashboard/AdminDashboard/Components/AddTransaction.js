...
function AddTransaction() {
  ...
  const addTransaction = async (e) => {
    ...
    if (
      ...
      console.log("Borrower detaails : ", borrower_details);
  ...
  return (
    <div>
      ...
      <form className="transaction-form" onSubmit={addTransaction}>
        <label className="transaction-form-label mb-2" htmlFor="borrowerId">
        ...
        <table
          className="admindashboard-table shortinfo-table mt-3"
        ...
        <DatePicker
                    ...
                    onChange={(date) => { setFromDate(date); 
                      setFromDateString(moment(date).format('YYYY-MM-DD ')) }}
                    minDate={new Date()}
       ...
       <br/>
        <DatePicker
          className="date-picker mb-4"
          placeholderText="MM/DD/YYYY"
          selected={toDate}
          onChange={(date) => {
            setToDate(date);
            setToDateString(moment(date).format(
              'YYYY-MM-DD  '
          ));
          }}
          minDate={new Date()}
